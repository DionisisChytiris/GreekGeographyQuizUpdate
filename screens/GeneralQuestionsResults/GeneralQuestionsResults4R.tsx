...
const GeneralQuestionsResults4R = () => {
  return (
    <View style={{flex: 1}}>
...
export default GeneralQuestionsResults4R
...
//   const GeneralQuestionsResults4R = () => {
//     const route = useRoute<GenQRRouteProp<"GeneralQuestionsResult4R">>();
