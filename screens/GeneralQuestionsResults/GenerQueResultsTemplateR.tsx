...
const GenerQueResultsTemplateR = (props: any) => {
  const route = useRoute<GenQRRouteProp<"GeneralQuestionsResult1R">>();
...
export default GenerQueResultsTemplateR;
