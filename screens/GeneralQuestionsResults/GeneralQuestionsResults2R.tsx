import {
  ...
  const GeneralQuestionsResults2R = () => {
    const route = useRoute<GenQRRouteProp<"GeneralQuestionsResult2R">>();
  ...
  export default GeneralQuestionsResults2R;
