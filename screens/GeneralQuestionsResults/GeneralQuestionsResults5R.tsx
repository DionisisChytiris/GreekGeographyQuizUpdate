...
const GeneralQuestionsResults5R = () => {
  return (
    <View style={{flex: 1}}>
...
export default GeneralQuestionsResults5R
...
//   const GeneralQuestionsResults5R = () => {
//     const route = useRoute<GenQRRouteProp<"GeneralQuestionsResult5R">>();
