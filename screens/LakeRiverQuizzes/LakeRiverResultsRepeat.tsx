import {
  ...
  type LakeRiverRepeatProp = StackNavigationProp<RootStackParamList, 'LakeRiverResultsRepeat'>
  type LakeRiverRepeatRouteProp<RouteName extends keyof RootStackParamList>= RouteProp<RootStackParamList, RouteName>
