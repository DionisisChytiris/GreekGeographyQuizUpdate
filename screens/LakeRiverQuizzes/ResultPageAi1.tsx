...
export default function ResultsScreen() {
  ...
  const renderIcon = (iconName: string) => {
    switch (iconName) {
      case "Brain":
        return <MaterialCommunityIcons name="brain" size={64} color="#fff" />;
      case "Medal":
        return <MaterialCommunityIcons name="medal" size={64} color="#fff" />;
      case "Trophy":
        return <MaterialCommunityIcons name="trophy" size={64} color="#fff" />;
      default:
        return null;
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          ...
          {/* <Brain
            ...
            /> */}
          <Text style={[styles.scoreTitle, { color: feedback.colors.text }]}>
            {feedback.title}
          </Text>
          <Text style={[styles.scoreText, { color: feedback.colors.text }]}>
          ...
          <Text
            style={[
              styles.scoreSubtext,
              { color: feedback.colors.text, fontSize: 14, marginTop: 10 },
            ]}
          >
            {feedback.message}
          </Text>
