import {
  ...
  type Nomoi6FinalProp = StackNavigationProp<RootStackParamList, 'Nomoi6Final'>
  type Nomoi6FinalRouteProps<RouteName extends keyof RootStackParamList> = RouteProp<RootStackParamList, RouteName>
          ...
          <View>
            ...
            { score === 100 ? (
              ...
              <View style={styles.buttonBox1}>
                ...
                <Pressable
                  onPress={() => navigation.navigate("Nomoi6R")}
                  style={styles.button0}
                >
                  <View style={styles.button1} />
                  <View style={styles.btnText}>
