...
type MountainResultsRepeatProp = StackNavigationProp<
  RootStackParamList,
  "MountainResults"
>;
type MountainRepeatRouteProp<RouteName extends keyof RootStackParamList> =
...
const MountainResultsRepeat = () => {
  ...
  // const score = 60;
  const scoreMountain = Math.floor(
