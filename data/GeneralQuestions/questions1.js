const questions1 =  [
    ...
    { 
        ...
        result1: 'Το Σκολιό είναι δεύτερη σε ύψος κορυφή στα 2.912μ. ',
        result1: 'Ο Κίσσαβος, γνωστός και με το όνομα Όσσα, βρίσκεται βορειοανατολικά του νομού Λάρισας απέναντι από τον Όλυμπο, με υψόμετρο στα 1.978μ.',
    },
    {
        id: 17,
