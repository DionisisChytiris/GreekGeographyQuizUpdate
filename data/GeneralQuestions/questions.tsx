const questions =  [
    ...
    {
        id: 7,
        question: "Ποιος νομός έχει τον μεγαλύτερο πληθυσμό;",
        options:[
            {
                id:"0",
                answer:"Ν.Μαγνησίας",
    ...
    },
    {
        ...
        result1: 'Τα Τρίκαλα βρίσκονται στην Θεσσαλία.',
        result2: "Η Βέροια, η Κατερίνη και τα Γιαννιτσά βρίσκονται στην Μακεδονία.",
        result3: "",
        result4: "",
    },
    {
        ...
        result1: 'Η παλιά πόλη της Ρόδου είναι χτισμένη από τους Ιωαννίτες ιππότες τον 13ο αιώνα. Υπάρχουν γραπτές μαρτυρίες που αναφέρουν πως εδώ υπήρχε φρούριο το οποίο προστάτευε τον πληθυσμό από εχθρικές επιδρομές από τον 7ο ακόμα αιώνα.',
        result2: "",
        result3: "",
        result4: "",
    },
    {
        id: 13,
        question: "Ποιος νομός φιλοξενεί το θέατρο της Επιδαύρου;",
        options:[
            {
                id:"0",
                answer:"Ν.Αρκαδίας",
    ...
    {
        id: 14,
        question: "Με ποια χώρα ΔΕΝ συνορεύει η Ελλάδα; ",
        options:[
            {
                id:"0",
                answer:"Αλβανία",
        ...
        correctAnswerIndex: 2,
        img: require('../../assets/generalQuestions/greece.jpg'),
        result1: 'Η Ελλάδα συνορεύει με την Αλβανία, την Βόρειο Μακεδονία, τη Βουλγαρία και την Τουρκία.',
        result2: "",
        result3: "",
        result4: "",
    },
    {
        ...
        result1: 'Η Ελλάδα συνορεύει με 4 χώρες: την Αλβανία, την Βόρειο Μακεδονία, τη Βουλγαρία και την Τουρκία.',
        result2: "",
        result3: "",
        result4: "",
    },
    ...
    {
        id: 24,
        question: "Πού βρίσκεται η παραλία Βοϊδοκοιλιά;",
        options:[
            {
                id:"0",
                answer:"Ν.Πρέβεζα",
