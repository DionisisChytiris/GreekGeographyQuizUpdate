const questions =  [
    ...
    {
        id:"5",
        question: "Τι ποσοστό της Ελλάδας είναι ορεινό; ",
        options:[
            {
                id:"0",
                answer:"40%",
    ...
    {
        id:"6",
        question: "Δεύτερο ψηλότερο βουνό της Ελλάδας;",
        options:[
            {
                id:"0",
                answer:"Γκιώνα",
    ...
    {
        id:"15",
        question: "Πού βρίσκεται το βουνό Καλιακούδα;",
        options:[
            {
                id:"0",
                answer:"Φωκίδα",
    ...
    {
        id:"17",
        question: "Ποιο βουνό λέγεται «Άγιο Βουνό» στην Ελλάδα;",
        options:[
            {
                id:"0",
                answer:"Παρνασσός",
    ...
    {
        id:"18",
        question: "Ποιο βουνό βρίσκεται στη Στερεά Ελλάδα; ",
        options:[
            {
                id:"0",
                answer:"Όλυμπος",
    ...
    {
        id:"21",
        question: "Σε ποιο βουνό είναι το χιονοδρομικό Καλαβρύτων; ",
        options:[
            {
                id:"0",
                answer:"Όλυμπος",
    ...
    {
        id:"22",
        question: "Σε ποιο βουνό λατρευόταν ο Δίας;",
        options:[
            {
                id:"0",
                answer:"Ταΰγετος",
    ...
    {
        id:"23",
        question: "Που βρίσκεται το καταφύγιο 'Σπήλιος Αγαπητός';",
        options:[
            {
                id:"0",
                answer:"Όλυμπος",
    ...
    {
        id:"24",
        question: "Σε ποιο βουνό είναι η σπηλιά Ανδρούτσου;",
        options:[
            {
                id:"0",
                answer:"Πίνδος",
    ...
    {
        id:"26",
        question: "Βουνό Μακεδονίας: ποιο είναι 2ο ψηλότερο;",
        options:[
            {
                id:"0",
                answer:"Βόρας",
    ...
    {
        id:"31",
        question: "Ποιο βουνό συνδέεται με το φαράγγι Λούσιου;",
        options:[
            {
                id:"0",
                answer:"Παρνασσός",
    ...
    {
        id:"32",
        question: "Βουνό που συνδέεται με τον Ορφέα,μυθολογία;",
        options:[
            {
                id:"0",
                answer:"Παρνασσός",
    ...
    {
        id:"33",
        question: "Βουνό της Στερεάς με χιονοδρομικό κέντρο;",
        options:[
            {
                id:"0",
                answer:"Όρθρυς",
    ...
    {
        id:"37",
        question: "Βουνό Θεσσαλίας με τη Λίμνη Πλαστήρα;",
        options:[
            {
                id:"0",
                answer:"Βέρμιο",
    ...
    {
        id:"38",
        question: "Σε ποιο βουνό είναι το χιονοδρομικό Καϊμακτσαλάν;",
        options:[
            {
                id:"0",
                answer:"Βόρας",
    ...
    {
        id:"39",
        question: "Ποιο βουνό χωρίζει το στενό της Πέτρας από τον Όλυμπο;",
        options:[
            {
                id:"0",
                answer:"Παρνασσός",
    ...
    {
        id:"40",
        question: "Ποιο βουνό συνδέεται με τον Ελικώνα και τις Μούσες;",
        options:[
            {
                id:"0",
                answer:"Παρνασσός",
    ...
    {
        id:"41",
        question: "Ποιο βουνό φιλοξενεί το μοναστήρι Σουμελά;",
        options:[
            {
                id:"0",
                answer:"Πίνδος ",
    ...
    {
        id:"43",
        question: "Βουνό Πελοποννήσου κοντά στην Τρίπολη;",
        options:[
            {
                id:"0",
                answer:"Ταΰγετος",
    ...
    {
        id:"45",
        question: "Βουνό της Κρήτης με το Σπήλαιο του Δία;",
        options:[
            {
                id:"0",
                answer:"Ψηλορείτης",
    ...
    {
        id:"47",
        question: "Βουνό γνωστό για το πέρασμα των Θερμοπυλών;",
        options:[
            {
                id:"0",
                answer:"Καλλίδρομο",
    ...
    {
        id:"48",
        question: "Βουνό Ηπείρου με κορυφή Τραπεζίτσα;",
        options:[
            {
                id:"0",
                answer:"Τύμφη",
    ...
    {
        id:"49",
        question: "Ποιο βουνό φιλοξενεί τη λίμνη του Μαυροβουνίου;",
        options:[
            {
                id:"0",
                answer:"Πίνδος",
    ...
    {
        id:"50",
        question: "Ποιο βουνό φιλοξενεί την αρχαία Δωδώνη;",
        options:[
            {
                id:"0",
                answer:"Μαίναλο",
