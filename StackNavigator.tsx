...
import {NomoiResult1, NomoiResult2, NomoiResult3, NomoiResult4, NomoiResult5, NomoiResult6} from './screens/NomoiResults'
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="NomoiResultTemplate" component={NomoiResultTemplate} options={{headerShown: false, orientation: 'portrait'}}/>
        ...
        <Stack.Screen name="GenerQuestTemplate" component={GenerQuestTemplate} options={{headerShown: false, orientation: 'portrait'}}/>
      </Stack.Navigator>
    </NavigationContainer>
  );
}
